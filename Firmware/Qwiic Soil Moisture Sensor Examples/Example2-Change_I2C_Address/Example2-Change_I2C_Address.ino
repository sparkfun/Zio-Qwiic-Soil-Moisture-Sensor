/******************************************************************************
  Zio Qwiic Soil Moisture Sensor Example 2 - base Reading
  Harry
  September 25, 2018

  This sketch demonstrates how to change the I2C Address
  of the Zio Qwiic Soil Moisture Sensor. The new address will be saved to the
  Sensor's EEPROM.

  The factory default slave address is 0x28.

  Note: If the Zio Qwiic Soil Moisture Sensor is connected but unresponsive, 
...
volatile byte qwiicAddress = 0x28;     //Default Address
...
void setup() {
  ...
  Serial.println("Zio Qwiic Soil Moisture Sensor found!");
