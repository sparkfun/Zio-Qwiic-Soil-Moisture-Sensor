/******************************************************************************
  Zio Qwiic Soil Moisture Sensor Firmware
  Harry
  September 25, 2018

  This is the firmware on the Zio Qwiic Soil Moisture Sensor. The default I2C Address is
  0x28;
...
volatile byte qwiicAddress  =    0x28; //default
...
void setup() {
  ...
  if (qwiicAddress == 0xFF) {
    //EEPROM has never been written before, use the default address 0x28.
    qwiicAddress = 0x28; //default
  }
